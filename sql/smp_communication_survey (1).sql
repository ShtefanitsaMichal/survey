...
--
-- Хост: 127.0.0.1
-- Час створення: Вер 16 2018 р., 10:04
...
--
-- Дамп даних таблиці `pyt_5`
--

INSERT INTO `pyt_5` (`id`, `session_id`, `intranet`, `comarch`, `bpcs`, `qms`, `sap`, `asseco`, `sanden_vision`, `facebook`, `smp_web_page`, `baza_sugestii`, `sanden_month_news`, `zmt`, `parcel_warehouse`, `lessons_learned`, `own_title`, `own`, `total`, `date`) VALUES
...
--
-- Дамп даних таблиці `pyt_6`
--

INSERT INTO `pyt_6` (`id`, `session_id`, `opcja_1`, `opcja_2`, `opcja_3`, `opcja_4`, `opcja_5`, `opcja_1_title`, `opcja_2_title`, `opcja_3_title`, `opcja_4_title`, `opcja_5_title`, `date`) VALUES
...
--
-- Дамп даних таблиці `pyt_7`
--

INSERT INTO `pyt_7` (`id`, `session_id`, `opcja_1`, `opcja_2`, `opcja_3`, `opcja_4`, `opcja_5`, `opcja_1_title`, `opcja_2_title`, `opcja_3_title`, `opcja_4_title`, `opcja_5_title`, `date`) VALUES
...
--
-- Індекси таблиці `pyt_5`
--
ALTER TABLE `pyt_5`
  ADD PRIMARY KEY (`id`);

--
-- Індекси таблиці `pyt_6`
--
ALTER TABLE `pyt_6`
  ADD PRIMARY KEY (`id`);

--
-- Індекси таблиці `pyt_7`
--
ALTER TABLE `pyt_7`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблиці `pyt_5`
--
ALTER TABLE `pyt_5`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT для таблиці `pyt_6`
--
ALTER TABLE `pyt_6`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT для таблиці `pyt_7`
--
ALTER TABLE `pyt_7`
