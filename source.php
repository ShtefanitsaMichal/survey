        ...
        <br>
            ...
            <!--Formularz metody post -> wysyłanie danych o ródle. 
                ...
                <form action="post/post_source.php" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <input v-if="total == 100" value="Pzejdź dalej" type="submit" name="send"  class="btn btn-success btn-lg" >

                                <!-- !zabronic wysyłanie formy na klick przycisku z clasem disabled --> 
                            <input v-else="total != 100" value="Pzejdź dalej" type="submit" name="send" class="btn btn-outline-secondary btn-lg disabled" disabled> 
                        </div>
