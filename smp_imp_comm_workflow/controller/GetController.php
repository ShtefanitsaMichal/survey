 ...
 //$SecondMainSource = '';
    ...
    class Get{
        ...
        public function main_source_1(){
            ...
            $max_int_key_1 = array_keys($main_source1, max($main_source1)); //Wyszukania na ktorej pozycji znajduję się maksymalnie znaczenie iloczynu

            $FirstMainSource = constant($max_int_key_1[0]);                 //Pobieranie z konstruktora nazwe źródła
        ...
        public function main_source_2(){
            ...
            $max_int_key = array_keys($main_source, max($main_source));                             //Wyszukania na ktorej pozycji znajduję się maksymalnie znaczenie iloczynu

            unset($main_source[$max_int_key[0]]);                                                   //Kasowanie żródła z maksymalnym znaczeniem  

            $max_int_key = array_keys($main_source, max($main_source));                             //Ponowne wyszukania na ktorej pozycji znajduję się maksymalnie znaczenie iloczynu
            
            $SecondMainSource = constant($max_int_key[0]);                                          //Pobieranie z konstruktora nazwe źródła
