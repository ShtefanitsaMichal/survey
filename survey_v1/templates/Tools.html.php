    ...
    <div class="row"> 
        <div class="col-12" >   
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-5">                                           
                        <label class="">4. spotkania działów dzienne / okresowe</label>
                    </div>
                    <div class="col-6">    
                ...
                <div class="row">
                    <div class="col-5">               
                        <label class="">5.  spotkania wydziałowe /produkcyjne ( regularne/ nieregularne)</label>
                    </div>
                    <div class="col-6">    
                ...
                <div class="row">
                    <div class="col-5">
                        <label>12.</label>
                        <input v-model="form.own_title" class="text" style="width: 70%" placeholder="Opcja własna">
                ...
                <br> 
                    ...
                    <div class="row">
                        <div class="col-10">
                            ...
                            <input v-else type="submit" value="Przejdź dalej" class="btn btn-outline-secondary btn-block disabled" name="send" disabled>
                        </div> 
                        <div class="col-2">
