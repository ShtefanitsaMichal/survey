...
<div class="container" style="margin: 5vh auto;">
  <div class="App">
    <div class="card border-dark mb-3" style="max-width: 100%;">
        ...
        <?php
          if ($main_source -> main_source_2() == 4) {
        ...
        <div class="row">
          <div class="col-md-12 ">
            <form action="post/post_rate.php" method="POST">
              ...
              <span v-if="opcja_1 != '' && opcja_2 != '' && opcja_3 != '' && opcja_4 != '' && opcja_5 != '' " > <input  value="Przejdź dalej" type="submit" name="send"   class="btn btn-success btn-lg btn-block"> </span>
              <span v-else> <input  value="Przejdź dalej" type="submit" name="send"   class="btn btn-outline-secondary btn-lg btn-block disabled"> </span>
            </form>
            </div>
          </div>
        </div>  
...
<script>
   new Vue({
          ...
          data: {
                  ...
                  opcja_2_title: '<?php $opcja_1 = key($main); print(constant($opcja_2)); next($main);?>',
                  opcja_3_title: '<?php $opcja_1 = key($main); print(constant($opcja_3)); next($main);?>',
                  opcja_4_title: '<?php $opcja_1 = key($main); print(constant($opcja_4)); next($main);?>',
                  opcja_5_title: '<?php $opcja_1 = key($main); print(constant($opcja_5)); next($main);?>',
                  opcja_1: '',
                  opcja_2: '',
                  opcja_3: '',
                  opcja_4: '',
