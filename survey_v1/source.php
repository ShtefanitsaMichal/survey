...
?>
    ...
    <div id="el">
    <div class="container col-8 offset-2" style="margin: 20vh auto;" >
    <div class="card border-secondary mb-3" >
        ...
        <div class="row">
            ...
            <div class="col-md-6">    
                <input v-model.number="form.przelozony " type="range"  class="custom-range " name="przelozony " id="przelozony "> 
            </div>
            <div class="col-md-2">
                    <span vclass="badge" :value="20">{{ form.przelozony  + "%" }}</span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <label data-toggle="popover" data-placement="bottom" title="Co znaczy?" data-content="Bazy danych / systemy informatyczne /ogłoszenia/bliuletyny/( Comarch, ASSECO, QMS, BPCS, strona www, tablice, Excell, etc.)" style="cursor: pointer;"><h5 class="text-secondary">System informatyczny <span ><i class="fas fa-question-circle"></i></span></h5></label> 
            </div>
            <div class="col-md-6">
        ...
        <br>
            ...
            <!--Formularz metody post -> wysyłanie danych o ródle. 
                ...
                <form action="post/post_source.php" method="post">
                    ...
                    <input type="hidden" name="przelozony" v-model="form.przelozony">
...
<script>  
    new Vue({
            ...
            computed: {
                udzial: function (){
                    let udzial = 100 - (this.form.zarzad + this.form.przelozony  + this.form.dzial + this.form.inny_dzial + this.form.baza_danych);
                    return udzial;
                },

                total: function () {
                    let calculatedTotal = this.form.zarzad + this.form.przelozony  + this.form.dzial + this.form.inny_dzial + this.form.baza_danych;
