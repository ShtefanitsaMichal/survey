    ...
    class Post 
    {
        ...
        function post_source(){
            ...
            try {
                ...
                $sql = $db->prepare("INSERT INTO source ( session_id ,zarzad, przylozony, dzial, inny_dzial, baza_danych, total)  
            ...
            try {
                ...
                $sql = $db->prepare("INSERT INTO source_rate (session_id ,zarzad, przylozony, dzial, inny_dzial, baza_danych) 
        ...
        function post_apps(){
            try {
                ...
                $sql = $db->prepare("INSERT INTO main_apps (`session_id` ,`intranet`, `comarch`, `bpcs`, `qms`, `sap`, `asseco`, `sanden_vision`, `facebook`, `smp_web_page`, `baza_sugestii`, `zmt`, `parcel_warehouse`, `lessons_learned`, `own_title` , `own`, `sanden_month_news`, `total` )  
                ...
                try {
                     ...
                     if (!isset($_POST['send']))
                     ...
                     else 
                        {
                         ...
                         $sql = $conn->prepare("INSERT INTO main_tools 
                                                        (`session_id`, `main_source`, `write`, `phone`, 
                                                            `face_to_face`, `dept_meet`, `prod_meet`, 
                                                            `proj_meet`, `budget_meet`, `smp_d`, 
                                                            `smp_w`, `cs`, `unformal_meet`, 
                                                            `own`, `own_title`, `total`)
                                                 VALUES ('$session_id', '$main_source', '$write', '$phone', 
                                                            '$face_to_face', '$dept_meet', '$prod_meet', 
                                                            '$proj_meet', '$budget_meet', '$smp_d', 
                                                            '$smp_w', '$cs', '$unformal_meet', 
                                                            '$own', '$own_title', '$total');");
